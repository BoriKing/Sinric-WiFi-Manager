...
void turnOn(String deviceId) {
  if (deviceId == (f_dID))
  {
    Serial.print("Swith 1 On: ");
    Serial.println(deviceId);
  }
  else if (deviceId == (s_dID))
  {
    Serial.print("Swith 2 On: ");
    Serial.println(deviceId);
  }
  else if (deviceId == (t_dID))
  {
    Serial.print("Swith 3 On: ");
    Serial.println(deviceId);
  }
  else if (deviceId == (fo_dID))
  {
    Serial.print("Swith 4 On: ");
    Serial.println(deviceId);
  }
  else {
...
void turnOff(String deviceId) {
  if (deviceId == (f_dID))
  {
    Serial.print("Swith 1 Off: ");
    Serial.println(deviceId);
  }
  else if (deviceId == (s_dID))
  {
    Serial.print("Swith 2 Off: ");
    Serial.println(deviceId);
  }
  else if (deviceId == (t_dID))
  {
    Serial.print("Swith 3 Off: ");
    Serial.println(deviceId);
  }
  else if (deviceId == (fo_dID))
  {
    Serial.print("Swith 4 Off: ");
    Serial.println(deviceId);
  }
  else {
    Serial.print("Unknown Device: ");
